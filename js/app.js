...
function getResult(element) {
  ...
  if (id === currentQuestion.answer) {
    ...
    // add the indicator to the correct answer
    updateAnswerIndicator("correct");
    correctAnswer++;
  } else {
    // set the red color to the incorrect option
    element.classList.add("wrong");
    // add the indicator to the incorrect answer
...
// make other options unclickable once an option is selected
...
function startQuiz() {
  ...
  // show the quizBox
  quizBox.classList.remove("hide");
  // let's first set all questions in availableQuestion Array
